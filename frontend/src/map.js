...
var OriginalPlacelat=25.033506;
var OriginalPlacelng=121.542027;
...
var osm = new L.TileLayer(osmUrl, {minZoom: 10, maxZoom: 16});
map.addLayer(osm);
var popup = L.popup(); 
...
map_drag()
  ...
  console.log("左下:"+leftdown)
  console.log("右上:"+rightup)
  console.log("左上:"+leftup)
  console.log("右下:"+rightdown)
 }
